...
INSERT INTO `society_app`.`sa_report` (`report_id`, `report_name`) VALUES ('3', 'Maintenance');
INSERT INTO `society_app`.`sa_general_head_section` (`section_id`, `section_name`, `report_id`) VALUES ('5', 'MAINTENANCE', '3');

alter table sa_society_config add start_date date;
alter table sa_society_config add end_date date;
alter table sa_society_config add maintenance_cycle int;